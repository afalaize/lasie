...
parameters = {'rot_center': rot_center,  # Center of rotation of ellipse
...
parameters = {'h_mesh': 0.008,  # mesh size w.r.t 1m (d.u.)
              }
...
parameters = {'pen': 1e-9,        # Coefficient de penalisation volumique (~0)
...
parameters['load'] = {'imin': NMIN,       # starting index
...
# ROM Time step
DT_ROM = TEXPORT*options['load']['decim']
